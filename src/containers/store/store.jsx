...
const Store = ({dispatch, sort, products, loading, error, match}) => {
...
const mapStateToProps = state => ({sort: state.products.sort, products: state.products.items, loading: state.products.loading, error: state.products.error});
